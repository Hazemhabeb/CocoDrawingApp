...
class SegmentViewModel constructor(private val segmentRepository: SegmentRepository, app:Application)  :
    AndroidViewModel(app) {

    val errorMessage = MutableLiveData<String>()
    val data = MutableLiveData<ArrayList<SegmentResponse>>()
    var job: Job? = null
...
//    }
    ...
    fun getData(queryType: String,images: ArrayList<String>) {
        ...
        job = CoroutineScope(Dispatchers.IO ).launch {
            val response = segmentRepository.getSegment(queryType,images)
